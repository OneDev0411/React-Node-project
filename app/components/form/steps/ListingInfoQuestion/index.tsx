...
const ListingInfoQuestion: React.FC<IQuestionProps> = ({
  ...
  const [listPrice, setListPrice] = useState<string>(
    Number(listPriceContextValue) + ""
  );
  const [listDate, setListDate] = useState<Date>(
    !listDateContextValue ? new Date() : new Date(listDateContextValue)
  ...
  return (
    <QuestionSection>
      <QuestionTitle>Please confirm or update the following:</QuestionTitle>
      <QuestionForm>
        <TextField
          size="small"
